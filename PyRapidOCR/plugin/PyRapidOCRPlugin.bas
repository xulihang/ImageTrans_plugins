...
public Sub Run(Tag As String, Params As Map) As ResumableSub
	...
	Select Tag
		...
		Case "getTextWithLocation"
			...
			Return regions
		Case "getSetupParams"
			Dim o As Object = CreateMap("readme":"https://github.com/xulihang/ImageTrans_plugins/tree/master/PyRapidOCR")
			Return o
		Case "getIsInstalledOrRunning"
			Wait For (CheckIsRunning) complete (running As Boolean)
			Return running
		Case "getDefaultParamValues"
			Return CreateMap("url": "http://127.0.0.1:8078/ocr")
	End Select
	Return ""
End Sub
...
Sub getUrl As String
	Dim url As String = "http://127.0.0.1:8078/ocr"
