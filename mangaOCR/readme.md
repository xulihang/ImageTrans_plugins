...
4. Unzip the [plugin files](https://github.com/xulihang/ImageTrans-docs/files/10716013/manga-ocr-plugin.zip) in ImageTrans's `plugins` folder and restart ImageTrans. (optional for v1.9.0+)
