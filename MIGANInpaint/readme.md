## MIGAN inpainting plugin for ImageTrans
...
PS: MIGAN will resize images too large, so it is recommended to process by text areas for large images. You can enable this in the project settings.
